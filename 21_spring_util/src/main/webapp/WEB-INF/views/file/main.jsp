...
<!DOCTYPE html>
<meta charset="utf-8">
<script src="${contextPath }/resources/jquery-3.3.1.min.js"></script>
<script>
...
<body>
	...
	<table border="1">			
		...
		<tr>
			<td><img src="${contextPath }/file/thumbnails?fileName=404.PNG" width="180px" height="100px"></td>
			<td>404 이미지</td>
			<td><a href="${contextPath }/file/download?fileName=404.PNG">다운로드</a></td>
		</tr>
		<tr>
			<td><img src="${contextPath }/file/thumbnails?fileName=500.PNG" width="180px" height="100px"></td>
			<td>500 이미지</td>
